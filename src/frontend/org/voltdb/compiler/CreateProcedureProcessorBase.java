...
public abstract class CreateProcedureProcessorBase extends StatementProcessor {

    protected class CreateProcedurePartitionData {
    ...
    protected CreateProcedurePartitionData parseCreateProcedureClauses(
        ...
        while (matcher.find(start)) {
            ...
            if (matcher.group(1) != null) {
                ...
                if (data != null) {
                    throw m_chain.m_compiler.new VoltCompilerException(
    ...
    protected void addProcedurePartitionInfo(
        ...
        m_chain.m_tracker.addProcedurePartitionInfoTo(procName, partitionInfo);
    }
}
